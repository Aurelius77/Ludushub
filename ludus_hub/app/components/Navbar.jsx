...
export default function Navbar(){
    return(
      ...
      <Image src={searchbtn} className='absolute left-2 top-1/2 -transform -translate-y-1/2' width='20' height='20' alt=''/>
      ...
      <div className="right flex items-center w-1/3 cursor-pointer">
        ...
        <div className="user flex items-center mr-5 ml-5">
          ...
          <Image src={profile} alt='login'/>
          <Image src={menu} className='block md:hidden ml-2' alt='menu'/>
        </div>
      </div>
      </nav>
        </>
